...
[STREAMING_CONCEPT.md](STREAMING_CONCEPT.md) — спецификация этапа B; реализация: [TASK_GEN_LOG_POOL](tasks/archive/TASK_GEN_LOG_POOL.md) (done), [TASK_HYBRID_BROADCAST](tasks/archive/TASK_HYBRID_BROADCAST.md) (done).
