...
6. [Миссии после пилота](#6-миссии-после-пилота)
...
## 6. Миссии после пилота

| Этап | Содержание |
| ---- | ---------- |
| Пилот | M1 — валидация pipeline (env → train → inference → дообучение) |
| Далее | M2–M6 после приёмки M1; каждая миссия — свой маршрут / эталон / поколения `genN` |
