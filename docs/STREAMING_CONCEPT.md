...
- [x] Каркас hybrid: короткий editorial (`--editorial` / `hybrid_episode_prep`) + live (`run_inference --show-window`) + Board (`streaming/board/`) — локально без Twitch ([TASK_HYBRID_BROADCAST](tasks/TASK_HYBRID_BROADCAST.md))
